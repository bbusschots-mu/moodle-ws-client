...
class MoodleWSClient{
    ...
    constructor(){
        ...
        // genereate the standard ping shortcut function
    ...
    /**
     * A function to register a single shortcut. This will create a funtion with
    ...
    registerShortcut(){
        ...
        // store the shortcut funtion with the requested name
