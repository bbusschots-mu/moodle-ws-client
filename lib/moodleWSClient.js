...
class MoodleWSClient{
     ...
     * @example <caption>A call with no web service arguments</caption>
     * let siteInfoPromise = myMoodleWS.submit('GET', 'core_webservice_get_site_info');
     * @example <caption>A call with web service arguments</caption>
...
/**
 * A custom error class for Moodle Web Service Exceptions.
 *
